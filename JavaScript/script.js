...
async function displayAlbums() {
    ...
    for (let i = 0; i < array.length; i++) {
        const e = array[i];
        // if(e.href.includes("http://127.0.0.1:5501/Songs/")) {
            if(e.href.includes("http://127.0.0.1:5501/Songs/") && !e.href.includes(".htaccess")) {
...
async function main() {
    ...
    // Add an event listner to mute the volume button
